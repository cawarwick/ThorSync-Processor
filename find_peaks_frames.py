...
def process_file(csv_file, output_dir, threshold=2.0, window_length=51, polyorder=0, scaling_factor=30):
    ...
    time_values = np.arange(0, len(data[:, 0]) / 1000, 1 / 1000)
    ...
    for peak_time in peak_times:
        target_time = peak_time + 2.1 ##this is in whatever unit the input is is, e.g. if you're put in frames make sure to convert 0.25 seconds to frames
...
input_dir = 'E:/#518/Thorsync/Frames and Force/'  # Replace with your input directory
